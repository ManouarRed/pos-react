...
export const productService = {
  ...
  bulkUpdateProductsAdmin: async (productIds: string[], updates: { categoryId?: string; manufacturerId?: string; isVisible?: boolean; }) => {
  ...
  // --- Sales ---
  submitSaleToHistory: async (saleItems: SaleItem[], totalAmount: number, paymentMethod: PaymentMethod, discount?: number, saleNotes?: string): Promise<SubmittedSale> => {
    const saleData = {
  ...
  uploadImageFile: async (file: File): Promise<{ imageUrl: string, fullSizeImageUrl: string }> => {
