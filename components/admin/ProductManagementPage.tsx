        ...
        for (let i = 0; i < jsonData.length; i++) {
          ...
          if (imageUrl) {
            try {
              ...
              const baseUrl = import.meta.env.VITE_API_BASE_URL || 'http://192.168.3.192:3001';
              productData.image = `${baseUrl}${uploadedImage.imageUrl}`; // Use the URL returned from the backend
              productData.fullSizeImage = `${baseUrl}${uploadedImage.fullSizeImageUrl}`; // Set full size image URL
